...
- You will be able to create, update and delete filters such as "Color" and "Make", and then match them in the "Product" creation form.
- You will be able to create, update and delete "Billboards" which are these big texts on top of the page. You will be able to attach them to a single category, or use them standalone (Our Admin generates API for all of those cases!)
- You will be able to Search through all categories, products, makes, colors, billboards with included pagination!
